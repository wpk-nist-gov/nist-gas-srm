...
release = version = nist_gas_srm.__version__
...
html_theme_options = {
    ...
    # "canonical_url": "",
    "repository_url": f"https://github.com/{github_username}/nist-gas-srm",
...
htmlhelp_basename = "nist_gas_srmdoc"
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    # fmt: off
    fn = os.path.relpath(fn, start=Path(nist_gas_srm.__file__).parent)
    # fmt: on

    return f"https://github.com/{github_username}/nist-gas-srm/blob/{html_context['github_version']}/src/nist_gas_srm/{fn}{linespec}"
